  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-4 bg-popover text-sm text-popover-foreground shadow-lg ring-1 ring-foreground/10 transition ease-in-out data-open:animate-in data-closed:animate-out data-closed:duration-200 data-open:duration-300',
          side === 'right' &&
            'inset-y-0 right-0 h-full w-full max-w-md border-l data-closed:slide-out-to-right data-open:slide-in-from-right',
          side === 'left' &&
            'inset-y-0 left-0 h-full w-full max-w-md border-r data-closed:slide-out-to-left data-open:slide-in-from-left',
          side === 'top' &&
